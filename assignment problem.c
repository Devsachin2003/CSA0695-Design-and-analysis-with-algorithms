...
int N; 
int minCost; 
int calculateCost(int costMatrix[MAX_SIZE][MAX_SIZE], int 
assignment[MAX_SIZE]) {
 int totalCost = 0;
 for (int i = 0; i < N; i++) {
...
void branchAndBound(int costMatrix[MAX_SIZE][MAX_SIZE], int row, int 
assignment[MAX_SIZE], int currentCost) {
 if (row == N) {
